            ...
            <div className={`${styles.titleiconinline} flex items-center mb-5`}>
              ...
              <div className={`${styles.arrowicon} ml-4`}>
                <svg width="45" height="46" viewBox="0 0 45 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g>
                    <rect y="0.769531" width="45" height="45" rx="22.5" fill="white"></rect>
                    <path d="M22.168 32.4349L31.3346 23.2682L22.168 14.1016" stroke="#1D3557" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M13 23.2695H31.3333" stroke="#1D3557" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                  </g>
                  <rect x="0.5" y="1.26953" width="44" height="44" rx="22" stroke="#BBC2CD"></rect>
                  <defs>
